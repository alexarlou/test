	...
	return (
		<UseToggle {...generateUseToggleConfig(attributes, manifest, 'headingUse')}>
			...
			>
				{!hideColor &&
					<ColorPicker
						label={(!hideSize && !hideFontWeight) ? null : <IconLabel icon={icons.color} label={__('Color', 'testinggg')} />}
				...
				{!hideFontWeight && fontSizes[fontSize]?.weightOptions?.length > 2 &&
					<Select
						...
						placeholder={__('Weight', 'testinggg')}
			...
			{!hideHeadingLevel &&
				<OptionSelector
					label={__('Heading level', 'testinggg')}
					options={[
						{ label: 'H1', tooltip: __('Heading 1', 'testinggg'), value: 1 },
						{ label: 'H2', tooltip: __('Heading 2', 'testinggg'), value: 2 },
						{ label: 'H3', tooltip: __('Heading 3', 'testinggg'), value: 3 },
						{ label: 'H4', tooltip: __('Heading 4', 'testinggg'), value: 4 },
						{ label: 'H5', tooltip: __('Heading 5', 'testinggg'), value: 5 },
						{ label: 'H6', tooltip: __('Heading 6', 'testinggg'), value: 6 },
					]}
					value={headingLevel}
